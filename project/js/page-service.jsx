// YOUKNOW Connect — Shared service-page sections
// Reused by services-cep.html, services-pa.html, services-bi.html, services-attribution.html
// Pass a config object describing the domain.
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 22 }}>
            ...
            <div style={{ display: 'flex', gap: 12, alignItems: 'center', marginTop: 6, flexWrap: 'wrap' }}>
              <Btn intent="primary" size="lg" href="contact.html">Get connected</Btn>
              <Btn intent="ghost" size="lg" href="partners.html">See the platforms →</Btn>
            </div>
          </div>
...
function ServicePartnersBlock({ cfg }) {
  // Renders ALL partners we use in this domain
  return (
...
function ServiceRelated({ cfg }) {
  // Cross-link to the other 3 domains
  const all = [
    { id: 'cep', label: 'Customer Engagement', tag: 'CEP', href: 'services-cep.html', body: 'Real-time messaging across every channel.' },
    { id: 'cdp', label: 'Customer Data Platform', tag: 'CDP', href: 'services-cdp.html', body: 'One trustworthy record per customer.' },
    { id: 'pa', label: 'Product Analytics', tag: 'PA', href: 'services-pa.html', body: "Answers GA4 can't give." },
    { id: 'bi', label: 'Business Intelligence', tag: 'BI', href: 'services-bi.html', body: 'Real-time dashboards for the whole business.' },
    { id: 'attribution', label: 'Mobile Attribution', tag: 'ATTR', href: 'services-attribution.html', body: 'Where users actually come from.' },
  ];
  const others = all.filter(s => s.id !== cfg.id);
  return (
    <section style={{ background: 'var(--ykc-white)', padding: '96px 0' }}>
      <div className="wrap">
...
Object.assign(window, { ServiceHero, ServiceWhatYouGet, ServicePartnersBlock, ServiceProblems, ServiceHowWePartner, ServiceQuote, ServiceFaq, ServiceRelated, ServicePage });
