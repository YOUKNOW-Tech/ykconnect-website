export default {
  ...
  description:
    'Why we partner with Amplitude for product analytics: funnels, retention curves, and feature adoption your product team can self-serve, alongside GA4 rather than instead of it.',
  date: '2026-07-06',
  ...
  body: [
    {
      type: 'p',
      text: 'You shipped a feature six weeks ago. Did it work? Not "did people click it", but did it actually move retention? If answering that means filing a ticket with an analyst and waiting three days, your product team isn’t making data-informed decisions. They’re making instinct-informed decisions with a data-flavoured delay.',
    },
    {
      type: 'p',
      text: 'GA4 can’t save you here, because GA4 was never built for this. It answers marketing questions: where did traffic come from, which campaign converted. What happens inside the product after the install is a different discipline with a different tool, and the tool we back for it is Amplitude.',
    },
    { type: 'h2', text: 'What Amplitude actually is' },
    {
      type: 'p',
      text: 'Amplitude is a product analytics platform, purpose-built rather than repurposed from web analytics. It models your product as events and users, then lets anyone ask behavioural questions, not just analysts: funnel analysis, cohort retention curves, user journey mapping, feature adoption. Its custom event taxonomy means you track what your product actually does, not what a page-view model assumes it does.',
    },
