export default {
  ...
  partner: 'Amperity',
  serviceHref: '/services/cdp',
  serviceName: 'Customer Data Platform',
  hero: '/assets/collages/drowning-in-data.png',
  ...
  body: [
    ...
    {
      type: 'p',
      text: 'Every downstream tool inherits that confusion. Personalisation misfires. Dashboards disagree. Consent gets honoured in one system and ignored in another. This is the problem Amperity was built to solve, and it’s why they’re our customer data platform partner.',
    },
    ...
    {
      type: 'cta',
      text: 'Nobody in your business agrees on the customer count? Let’s fix the record.',
      href: '/services/cdp',
      label: 'Explore our customer data platform service',
    },
  ],
};
