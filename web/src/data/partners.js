...
export const PARTNERS_DATA = [
  {
    ...
    items: [
      ...
      {
        slug: 'insiderone',
        name: 'InsiderOne', role: 'CEP + AI Personalisation + CDP',
        what: "AI-native cross-channel engagement, Insider One AI adds predictive and agentic intelligence, plus a built-in CDP and deep on-site personalisation, across 12+ channels including WhatsApp and site search. Particularly strong in retail, e-commerce, and travel, where the website experience matters as much as the message.",
        overview: "InsiderOne earns its keep where the on-site experience and the outbound message need to move as one system, not two. Its Insider One AI layer adds predictive and agentic intelligence on top of a built-in CDP and cross-channel orchestration, which matters most for retail, e-commerce, and travel businesses where a mistimed banner or a generic homepage costs real revenue. It's also the platform of choice behind some of SA retail's biggest names, Shoprite and Massmart among them, so the enterprise-scale claims hold up.",
        weOffer: "We configure the data model and CDP setup that InsiderOne's AI personalisation actually depends on, build out the agentic rules and journeys that decide what each visitor sees and receives across WhatsApp, email, and on-site, and get marketing and product teams trained to run and iterate on campaigns without engineering in the loop.",
        bestFor: "Companies where website experience, AI-driven personalisation, and customer comms must work as one: retail, e-commerce, travel.",
        wedoes: ['Data model', 'CDP config', 'AI personalisation rules', 'Marketing+product training'],
    ...
    items: [
      {
        ...
        what: "Market-leading mobile measurement partner. A neutral measurement layer above Meta, Google, TikTok, ASA and beyond, with Protect360 fraud protection and OneLink deep linking built in. Privacy-preserving framework built for iOS/Android post-IDFA.",
        overview: "AppsFlyer is the neutral referee sitting above Meta, Google, TikTok, and every other channel you're paying to acquire users on, telling you the truth about what's actually working. Protect360 catches fraud in real time before it burns budget, OneLink routes every ad, email, and social click straight to the right in-app moment, and the measurement framework was built for the post-IDFA world, not bolted onto an older one.",
        weOffer: "We handle the SDK implementation, wire up your partner integrations across thousands of ad networks and analytics tools, and set attribution windows that match how your app actually converts. We also configure Protect360's fraud rules tuned to your specific acquisition mix and set up OneLink so every campaign link lands users exactly where it should, so your paid budget goes toward real users, not bots or a dropped homescreen.",
        bestFor: "Apps running paid acquisition at scale across multiple channels, especially where fraud is a concern.",
        wedoes: ['Implementation', 'OneLink deep linking', 'Protect360 fraud rules', 'Attribution windows'],
      ...
      },
      {
        ...
        what: "Leading deep linking combined with solid mobile attribution. Universal links, deferred deep links, contextual deep links, so every campaign, email, push, or social link drops users exactly where they should land. Journeys turns mobile web traffic into app installs, and Fraud Shield keeps bad clicks from ever getting attributed.",
        overview: "Branch matters most the moment a link is supposed to take someone somewhere specific inside your app and instead dumps them on the home screen. It combines leading deep linking, universal links, deferred deep links, contextual deep links, with solid mobile attribution, so every campaign, email, push, or social link actually lands where it's meant to. Deferred deep linking means even a brand-new install still ends up on the right screen, and its privacy-first architecture keeps measurement accurate under ATT, Privacy Sandbox, and SKAdNetwork.",
        weOffer: "We build out the link infrastructure and wire it into your CEP so campaigns and deep links work as one system, then QA every flow across devices and states before go-live. We test the edge cases most teams skip, like a fresh install versus an already-installed user tapping the same link, so nothing breaks in production. We'll also set up Journeys smart banners to convert mobile web visitors into app users, and tune Fraud Shield's rules to your acquisition mix so junk clicks don't skew your numbers.",
        bestFor: "Apps where deep linking is core to the experience: email-to-app, web-to-app, social-to-app flows, especially where Journeys' smart banners can turn casual web visitors into app users.",
        wedoes: ['Link infrastructure', 'Journeys smart banners', 'Fraud Shield setup', 'Go-live testing'],
